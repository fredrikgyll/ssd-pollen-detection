...
GT_PATH = os.path.join(args.input, "ground-truth")
DR_PATH = os.path.join(args.input, "detection-results")
# if there are no images then no animation can be shown
IMG_PATH = os.path.join(args.input, "input", "images-optional")
...
"""
TEMP_FILES_PATH = os.path.join(args.input, ".temp_files")
if not os.path.exists(TEMP_FILES_PATH):  # if it doesn't exist already
    os.makedirs(TEMP_FILES_PATH)
output_files_path = os.path.join(args.input, "output")
